...
describe("A game of klondike", function () {
    ...
    describe("with an unshuffled deck", function () {
        ...
        it("should allow moving second tableau's ace to first foundation and turns over next card in second tableau",
            function () {
        ...
        it(", if we reverse remainder (hack the scenario) so 7 of clubs is on top, should allow moving foundation's 7 of clubs to last tableau's 8 of diamonds",
            function () {
